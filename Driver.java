   ...
   public void fillCompetencyCombo()
    ...
    { 
      ...
      {   
          ...
          String selectedCom = competencyCombo.getSelectedItem().toString();
          catalog.printSelectedCourses(selectedDept,selectedCom);
          System.out.println ("Selected department is: " + selectedDept);
          System.out.println ("Selected competency is: " + selectedCom);
      }
    } 
